...
def build_intake_override_log(
    *,
    ...
    return IntakeOverrideLog(
        ...
        llm_tagging_adjudication_used=llm_tagging_adjudication_used,
        llm_tagging_adjudication_reason=(llm_tagging_adjudication_reason or "").strip() or None,
        llm_slot_adjudication_used=llm_slot_adjudication_used,
        llm_slot_adjudication_reason=(llm_slot_adjudication_reason or "").strip() or None,
