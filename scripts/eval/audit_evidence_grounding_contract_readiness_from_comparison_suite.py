...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Build a contract compatibility report from a fixed-goldset comparison suite, then audit whether "
            "the artifact family has enough migration, backfill, public contract, and approval evidence for "
            "stable external contract consideration."
        )
    )
