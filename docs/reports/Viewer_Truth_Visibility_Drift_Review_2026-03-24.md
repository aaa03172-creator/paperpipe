...
- product positioning already says narrated demos do not count as readiness
...
### A. Product rule already prefers visible system truth over narrated demos

Repo anchors:
- `docs/Product_Positioning_Principles.md`

Why this is aligned:
- the active positioning doc already says product-ready flows should expose real saved state and provenance directly enough for inspection
- it also explicitly rejects demos that depend on verbal patching over hidden storage or missing provenance
...
- that is too broad now that the product rule explicitly rejects narrated demos and hidden system truth
